<template>
    ...
    <section class="bg-white py-20 dark:bg-dark lg:py-[120px]">
                ...
                <div class="w-full px-4 lg:w-10/12">
                    <div class="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
                        <div class="absolute left-0 top-0 h-full w-full">
                            <img src="assets/images/videos/image-01.jpg" alt="image"
                        ...
                        <div
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <svg width="23" height="27" viewBox="0 0 23 27" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="ml-1 fill-current">
                                    <path
                        ...
                        <div>
                            <span class="absolute left-4 top-4 z-40">
                                <svg width="50" height="79" viewBox="0 0 50 79" fill="none"
        ...
        <div :show="videoOpen" x-transition
