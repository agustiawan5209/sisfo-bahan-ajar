        ...
        <div class="flex h-screen">
            ...
            <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div class="max-w-md w-full p-6">
                    <h1 class="text-3xl font-semibold mb-6 text-black text-center">Masuk</h1>
                    ...
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <div>
                            <InputLabel for="confirmed_password" class="block text-sm font-medium text-gray-700 capitalize">konfirmasi password</InputLabel>
                            <TextInput type="password" id="confirmed_password" name="confirmed_password"
                                class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
                        </div>
                        <div>
                            <button type="submit"
                    ...
                    <div class="mt-4 text-sm text-gray-600 text-center">
                        <p>Sudah Punya Akun? <Link href="/login" class="text-black hover:underline">login disini</Link>
                        </p>
                    </div>
                </div>
            </div>
